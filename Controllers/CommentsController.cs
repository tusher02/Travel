...
namespace Travel.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "commentId,commentDesc,userId,postId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "commentId,commentDesc,userId,postId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
